...
tags:
  - blogdown
image: 'portfolio/old_r_webgraphic.png'
showonlyimage: true
---
...
tag *portfolio* posts with images. This works for both the *portfolio* and
*blog* posts - there is an ability to `showonlyimage:` and to control the
amount of the post that is displayed with the `<!--more-->` tag -- awesomeness.

This doesn't mean that everything is perfect - but we are certainly a step
closer to where I would like things to be!
